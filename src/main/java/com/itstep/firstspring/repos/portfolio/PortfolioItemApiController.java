...
public class PortfolioItemApiController {
    ...
    public PortfolioItemApiController(PortfolioItemRepository itemRepository, PortfolioCategoryRepository categoryRepository, PortfolioTagRepository tagRepository) {
